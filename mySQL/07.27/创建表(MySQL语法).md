...
insert into student(sno, sname, ssex, classNO) values (106, '沈月', '女', 90301);
...
insert into course(cno, cname, tno) values (3102, '经济法', 9013);
...
insert into score(sno, cno, degree) values(104, 4103, 78);
