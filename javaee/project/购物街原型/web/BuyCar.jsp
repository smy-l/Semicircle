    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $(".car_btn_2").click(function () {
                var c = $(this).siblings()[1].value;
                alert($(this).siblings()[0].value + "位置0");
                alert($(this).siblings()[1].value + "位置1");// num
                alert($(this).siblings()[2].value + "位置2");// id
                alert($(this).siblings()[3].value + "位置3");

                // alert(c)
                // c = parseInt(c) + 1;
                // alert(c);
                // $(this).siblings()[1].value = c;

                var id = $(this).siblings()[2].value;
                var param = "proId=" + id + "&proNum=" + c;

                $.post("checkStock.do", param, function (result) {
                    if (result == 1) {
                        $("#stockNotEnough").hide();
                    } else {
                        $("#stockNotEnough").show();
            ...
            $(".car_btn_1").click(function () {
                var c = $(this).siblings()[0].value;
                alert($(this).siblings()[0].value + "位置0");// num
                alert($(this).siblings()[1].value + "位置1");// id
                alert($(this).siblings()[2].value + "位置2");
                alert($(this).siblings()[3].value + "位置3");
...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="Login.jsp">登录</a>&nbsp; <a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a
                    href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<%--                            <input id="proId" type="text" style="display: none" value="${item.key.id}"/>--%>
                            <input id="delNum" type="button" value="" onclick="jianUpdate1(jq(this));"
                                   class="car_btn_1"/>
                            <input id="numText" type="text" value="1" name="" class="car_ipt"/>
                            <input type="hidden" class="product_id" value="${item.key.id}"/>
                            <input id="addNum" type="button" value="" onclick="addUpdate1(jq(this));"
                                   class="car_btn_2"/>
                        </div>
            ...
            <tr valign="top" height="150">
                <td colspan="6" align="right">
                    <a href="#"><img src="images/buy1.gif"/></a>&nbsp; &nbsp; <a href="count.do"><img
