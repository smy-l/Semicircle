package practice6_22.club.banyuan.firm;
...
public class Staff {
    ...
    public Staff() {
        ...
        staffList[6] = new Commission("和二", "栖霞", "13812345678", "020-56-3345", 6.25, 0.2);
        staffList[7] = new Commission("金三", "玄武", "15012345678", "010-34-6735", 9.75, 0.15);
