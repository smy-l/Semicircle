...
F. 运行错误
```
***答：A 当程序运行的时候先执行static语句，调用构造方法后，执行代码块***
...
F. 6
```
***答：C 调用方法1的时候你调用方法3，方法3又调用方法1，死循环***
...
E. 编译错误
```
***答：D static变量····，num1 = num1 局部变量覆盖掉局部变量，和成员变量毫无关系***
...
D. 没有输出
```
***答：A 局部变量和成员变量重名，局部变量覆盖成员变量，3，6，9***
